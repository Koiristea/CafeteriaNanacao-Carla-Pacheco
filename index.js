...
const cafes = JSON.parse(readFileSync(join(__dirname, "cafes.json"), "utf8"))

// Solo inicia el server si no está en modo test
...
app.delete("/cafes/:id", (req, res) => {
  ...
  if (jwt) {
    ...
    res
      .status(401)
      .send({ message: "No tienes autorización para eliminar cafés" })
  }
})
